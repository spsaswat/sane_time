...
public class Hobby_Exercise_Wkdy extends AppCompatActivity {
    String select;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hobby__exercise__wkdy);
    ...
    public void insertHOBBY(View view){
        ...
        if(t1_int<24 && t1_int>=0 && t2_int<24 && t2_int>=0 && t3_int<24 && t3_int>=0 && t4_int<24 && t4_int>=0 && t5_int<24 && t5_int>=0 && t1_int_m<60 && t1_int_m>=0 && t2_int_m<60 && t2_int_m>=0 && t3_int_m<60 && t3_int_m>=0 && t4_int_m<60 && t4_int>=0 && t5_int_m<60 && t5_int_m>=0) {
            boolean isin = myDb.insertDataHOBBY_WKDY(UID.getText().toString(), select, s1, s2, s3, s4, s5);
            if (isin == true)
    ...
    public void view_allHOBBY(View view){
        UID=user.uid;
        Cursor res=myDb.get_all_dataHOBBY_WKDY(UID.getText().toString());
        if(res.getCount()==0){
    ...
    public void update_dataHOBBY(View view){
        ...
        if(t1_int<24 && t1_int>=0 && t2_int<24 && t2_int>=0 && t3_int<24 && t3_int>=0 && t4_int<24 && t4_int>=0 && t5_int<24 && t5_int>=0 && t1_int_m<60 && t1_int_m>=0 && t2_int_m<60 && t2_int_m>=0 && t3_int_m<60 && t3_int_m>=0 && t4_int_m<60 && t4_int>=0 && t5_int_m<60 && t5_int_m>=0) {
            boolean isUpdate = myDb.update_dbmsHOBBY_WKDY(UID.getText().toString(), select, s1, s2, s3, s4, s5);
            if (isUpdate == true)
    ...
    public void delete_dataHOBBY(View view){
        UID=user.uid;
        int r=myDb.delete_dbmsHOBBY_WKDY(UID.getText().toString(),select);
        if(r==1)
