...
public class Personal_Cleanliness_Wkdy extends AppCompatActivity {
String select;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_personal__cleanliness__wkdy);
    ...
    public void insertCLEAN(View view){
        ...
        if(t1_int<24 && t1_int>=0 && t2_int<24 && t2_int>=0 && t3_int<24 && t3_int>=0 && t4_int<24 && t4_int>=0 && t5_int<24 && t5_int>=0 && t1_int_m<60 && t1_int_m>=0 && t2_int_m<60 && t2_int_m>=0 && t3_int_m<60 && t3_int_m>=0 && t4_int_m<60 && t4_int>=0 && t5_int_m<60 && t5_int_m>=0) {
            boolean isin = myDb.insertDataPERSONAL_CLEANLINESS_WKDY(UID.getText().toString(), select, s1, s2, s3, s4, s5);
            if (isin == true)
    ...
    public void view_allCLEAN(View view){
        UID=user.uid;
        Cursor res=myDb.get_all_dataPERSONAL_CLEANLINESS_WKDY(UID.getText().toString());
        if(res.getCount()==0){
    ...
    public void update_dataCLEAN(View view){
        UID=user.uid;
        String s1,s2,s3,s4,s5;
        s1= (!(t1_m.getText().toString().isEmpty()))?(t1.getText().toString()+":"+t1_m.getText().toString()):t1.getText().toString();
        s2= (!(t2_m.getText().toString().isEmpty()))?(t2.getText().toString()+":"+t2_m.getText().toString()):t2.getText().toString();
        ...
        if(t1_int<24 && t1_int>=0 && t2_int<24 && t2_int>=0 && t3_int<24 && t3_int>=0 && t4_int<24 && t4_int>=0 && t5_int<24 && t5_int>=0 && t1_int_m<60 && t1_int_m>=0 && t2_int_m<60 && t2_int_m>=0 && t3_int_m<60 && t3_int_m>=0 && t4_int_m<60 && t4_int>=0 && t5_int_m<60 && t5_int_m>=0) {
            boolean isUpdate = myDb.update_dbmsPERSONAL_CLEANLINESS_WKDY(UID.getText().toString(), select, s1, s2, s3, s4, s5);
            if (isUpdate == true)
    ...
    public void delete_dataCLEAN(View view){
        UID=user.uid;
        int r=myDb.delete_dbmsPERSONAL_CLEANLINESS_WKDY(UID.getText().toString(),select);
        if(r==1)
