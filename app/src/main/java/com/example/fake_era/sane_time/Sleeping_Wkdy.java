...
public class Sleeping_Wkdy extends AppCompatActivity {
String select;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sleeping__wkdy);
    ...
    public void insertSLEEP(View view){
        ...
        if(t1_int<24 && t1_int>=0 && t2_int<24 && t2_int>=0 && t3_int<24 && t3_int>=0 && t4_int<24 && t4_int>=0 && t5_int<24 && t5_int>=0 && t1_int_m<60 && t1_int_m>=0 && t2_int_m<60 && t2_int_m>=0 && t3_int_m<60 && t3_int_m>=0 && t4_int_m<60 && t4_int>=0 && t5_int_m<60 && t5_int_m>=0) {
            boolean isin = myDb.insertDataSLEEPING_WKDY(UID.getText().toString(), select, s1, s2, s3, s4, s5);
            if (isin == true)
    ...
    public void view_allSLEEP(View view){
        UID=user.uid;
        Cursor res=myDb.get_all_dataSLEEPING_WKDY(UID.getText().toString());
        if(res.getCount()==0){
    ...
    public void update_dataSLEEP(View view){
        ...
        if(t1_int<24 && t1_int>=0 && t2_int<24 && t2_int>=0 && t3_int<24 && t3_int>=0 && t4_int<24 && t4_int>=0 && t5_int<24 && t5_int>=0 && t1_int_m<60 && t1_int_m>=0 && t2_int_m<60 && t2_int_m>=0 && t3_int_m<60 && t3_int_m>=0 && t4_int_m<60 && t4_int>=0 && t5_int_m<60 && t5_int_m>=0) {
            boolean isUpdate = myDb.update_dbmsSLEEPING_WKDY(UID.getText().toString(), select, s1, s2, s3, s4, s5);
            if (isUpdate == true)
    ...
    public void delete_dataSLEEP(View view){
        UID=user.uid;
        int r=myDb.delete_dbmsSLEEPING_WKDY(UID.getText().toString(),select);
        if(r==1)
